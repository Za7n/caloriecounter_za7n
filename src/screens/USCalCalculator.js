...
//    let found = (searchresult !== null && searchresult !== undefined);
    ...
    function calcBMR() {
        if (gender == "M") {
            ...
            let bmr = 66.47 + (6.24 * weight1) + (12.7 * height1) - (6.75 * age1);
            setresult(bmr);
            ...
            height1 = parseInt(height);
            age1 = parseInt(age);
            let bmr = 65.51 + (4.35 * weight1) + (4.7 * height1) - (4.7 * age1);
            setresult(bmr);
    ...
    return (
        <ScrollView style={styles.bc}>
            <View style={styles.bc}>
             <Text style={styles.textLabel}>Enter the weight (in Ibs):</Text>
                <TextInput
                ...
                />
                <Text style={styles.textLabel}>Enter the height (in inches):</Text>
...
export default USCalCalculator;
